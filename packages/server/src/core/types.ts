...
// Agent roles
export const AGENT_ROLES = ['lead', 'director', 'worker', 'reviewer', 'product-thinker', 'qa-tester', 'tech-writer'] as const;
...
// Agent status
export const AGENT_STATUSES = ['idle', 'busy', 'hibernated', 'errored', 'retired'] as const;
