...
describe('LearningsStore', () => {
  ...
  it('appends and lists learnings', () => {
    store.append({ agentId: 'a1', content: 'Use facade pattern', tags: ['arch'] });
    store.append({ agentId: 'a2', content: 'SQLite needs WAL mode', tags: ['db'] });
  ...
  it('searches by content', () => {
    store.append({ agentId: 'a1', content: 'Always use TypeScript', tags: ['ts'] });
    store.append({ agentId: 'a1', content: 'Python import issues', tags: ['py'] });
  ...
  it('searches by tags', () => {
    store.append({ agentId: 'a1', content: 'test', tags: ['architecture'] });
  ...
  it('writes to memory/learnings.md', () => {
    store.append({ agentId: 'a1', content: 'Test learning', tags: ['test'] });
    const filePath = join(testDir, 'memory', 'learnings.md');
